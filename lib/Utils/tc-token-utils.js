...
export async function buildTcTokenFromJid({ authState, jid, getLIDForPN }) {
    try {
        ...
        // return single tctoken node — caller nests it inside <picture> (#2589)
        // t attr = token expiration timestamp, matches WA Web wire format
        return {
            tag: 'tctoken',
