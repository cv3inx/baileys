...
import { resolveCache, resolveCachePreset } from '../Utils/shared-caches.js';
...
export const makeMessagesSocket = (config) => {
    ...
    const userDevicesCache = config.userDevicesCache ||
        resolveCache(config.sharedCaches, 'userDevices', config.cacheId, () => new NodeCache({
    ...
    const messageRetryManager = enableRecentMessageCache
        ? new MessageRetryManager(logger, maxMsgRetryCount, resolveCachePreset(config.cachePreset))
        : null;
